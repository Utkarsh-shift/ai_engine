...
def classify_direction(pitch, roll, yaw):
    direction_vector = compute_face_direction(pitch, roll, yaw)
...
def count_facing_directions(data):
    ...
    return counts,data[1],data[2],data[3],data[4]
def faceTrack(filepath):
   ...
   # Main loop for video capture and processing
    ...
    return [dataList,watchLeft,watchcenter,watchright,blink]


# # if __name__=="__main__":
# data = count_facing_directions(faceTrack("./datasets/ChaLearn/test/hi.mp4"))
# print(data)