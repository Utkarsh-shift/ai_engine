...
class VideoData(Dataset):
    ...
    def parse_data_dir(self, data_dir):
        ...
        if isinstance(data_dir, list):
            ...
            path = os.path.join(os.getcwd(), "datasets/",data_dir)
            # path="resultsUI/datasets/ChaLearn/test_data" # changed path
            data_dir_ls = sorted(os.listdir(path))
    ...
    def parse_annotation(self, label_file):
        ...
        if isinstance(label_file, list):
            ...
            for label_i in label_file:
                ...
                label_path = os.path.join(os.getcwd(), "datasets/annotation_test.pkl") 
            ...
            label_path = ""
            label_path = os.path.join(os.getcwd(), "datasets/annotation_test.pkl") 
            # label_path="resultsUI/datasets/annotation_test.pkl" # changed path
            with open(label_path, "rb") as f:
