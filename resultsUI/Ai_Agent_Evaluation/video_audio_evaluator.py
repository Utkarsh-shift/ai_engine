...
#         print("DEBUG: Sending messages to OpenAI:", messages)
...
#         print("DEBUG: Raw OpenAI response:", raw_output)
...
#     # clean_audio(r"/disk/AWS/resultsUI/Ai_Agent_Evaluation/ai_agent_database/ChaLearn/test/final_video.mp4")
#     result=test()
...
#     del audio
#     gc.collect()
#     print("The chunks are , ********The chunks are , ********The chunks are , ********The chunks are , ********" , chunks)
#     return chunks  
...
#         print( "Total words in transcription: , agent one are ", total_words,"__________________________________________")
...
⚠️ Return only the certification names as a **numbered list**. No descriptions or organizations.
"""
